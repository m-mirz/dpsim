...
public:
  ...
  void setParameters(Matrix seriesResistance, Matrix seriesInductance,
                     ...
                     Matrix parallelConductance = Matrix::Zero(3, 3)) {
  ...
  void setParameters(Real seriesResistance, Real seriesInductance,
    ...
    **mParallelCond =
        Math::singlePhaseParameterToThreePhase(parallelConductance);
    **mParallelCap =
        Math::singlePhaseParameterToThreePhase(parallelCapacitance);
  }
};
} // namespace Ph3
} // namespace Base
