...
void addDPPh1Components(py::module_ mDPPh1) {
  ...
  py::class_<CPS::DP::Ph1::VSIVoltageControlDQ,
             ...
             CPS::SimPowerComp<CPS::Complex>>(mDPPh1, "VSIVoltageControlDQ",
                                              py::multiple_inheritance())
      .def(py::init<std::string, CPS::Logger::Level>(), "name"_a,
           "loglevel"_a = CPS::Logger::Level::off)
      ...
      .def("set_parameters", &CPS::DP::Ph1::VSIVoltageControlDQ::setParameters,
           "sys_omega"_a, "vdref"_a, "vqref"_a)
      .def("set_filter_parameters",
           &CPS::DP::Ph1::VSIVoltageControlDQ::setFilterParameters, "Lf"_a,
           "Cf"_a, "Rf"_a, "Rc"_a)
      .def("set_controller_parameters",
           &CPS::DP::Ph1::VSIVoltageControlDQ::setControllerParameters,
           "Kp_voltage_ctrl"_a, "Ki_voltage_ctrl"_a, "Kp_curr_ctrl"_a,
           "Ki_curr_ctrl"_a, "omega_cutoff"_a)
      .def("set_transformer_parameters",
           &CPS::DP::Ph1::VSIVoltageControlDQ::setTransformerParameters,
      ...
      .def("set_initial_state_values",
           &CPS::DP::Ph1::VSIVoltageControlDQ::setInitialStateValues,
