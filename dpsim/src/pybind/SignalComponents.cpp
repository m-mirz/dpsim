...
void addSignalComponents(py::module_ mSignal) {
  ...
  // VSI Controllers
  py::class_<CPS::Signal::VSIControlType1,
             std::shared_ptr<CPS::Signal::VSIControlType1>,
             CPS::Base::VSIControlDQ>(mSignal, "VSIControlType1",
                                      py::multiple_inheritance())
      .def(py::init<std::string, CPS::Logger::Level>(), "name"_a,
           "loglevel"_a = CPS::Logger::Level::off);
  py::class_<CPS::Signal::VSIControlType2,
             std::shared_ptr<CPS::Signal::VSIControlType2>,
             CPS::Base::VSIControlDQ>(mSignal, "VSIControlType2",
                                      py::multiple_inheritance())
      .def(py::init<std::string, CPS::Logger::Level>(), "name"_a,
           "loglevel"_a = CPS::Logger::Level::off);
  py::class_<CPS::Signal::VSIControlType3,
             std::shared_ptr<CPS::Signal::VSIControlType3>,
             CPS::Base::VSIControlDQ>(mSignal, "VSIControlType3",
                                      py::multiple_inheritance())
      .def(py::init<std::string, CPS::Logger::Level>(), "name"_a,
           "loglevel"_a = CPS::Logger::Level::off);
  py::class_<CPS::Signal::VSIControlType4,
             std::shared_ptr<CPS::Signal::VSIControlType4>,
             CPS::Base::VSIControlDQ>(mSignal, "VSIControlType4",
                                      py::multiple_inheritance())
      .def(py::init<std::string, CPS::Logger::Level>(), "name"_a,
           "loglevel"_a = CPS::Logger::Level::off);

  py::class_<CPS::Signal::VSIControlType1Parameters,
             std::shared_ptr<CPS::Signal::VSIControlType1Parameters>,
             CPS::Base::VSIControlParameters>(
      mSignal, "VSIControlType1Parameters", py::multiple_inheritance())
      .def(py::init())
  ...
  py::class_<CPS::Signal::VSIControlType2Parameters,
             std::shared_ptr<CPS::Signal::VSIControlType2Parameters>,
             CPS::Base::VSIControlParameters>(
      mSignal, "VSIControlType2Parameters", py::multiple_inheritance())
      .def(py::init())
      ...
      .def_readwrite("omegaNom",
                     &CPS::Signal::VSIControlType2Parameters::omegaNom)
      .def_readwrite("Cf", &CPS::Signal::VSIControlType2Parameters::Cf)
      .def_readwrite("Lf", &CPS::Signal::VSIControlType2Parameters::Lf);

  py::class_<CPS::Signal::VSIControlType3Parameters,
             std::shared_ptr<CPS::Signal::VSIControlType3Parameters>,
             CPS::Base::VSIControlParameters>(
      mSignal, "VSIControlType3Parameters", py::multiple_inheritance())
      .def(py::init())
  ...
  py::class_<CPS::Signal::VSIControlType4Parameters,
             std::shared_ptr<CPS::Signal::VSIControlType4Parameters>,
             CPS::Base::VSIControlParameters>(
      mSignal, "VSIControlType4Parameters", py::multiple_inheritance())
      .def(py::init())
      ...
      .def_readwrite("omegaNom",
                     &CPS::Signal::VSIControlType4Parameters::omegaNom)
